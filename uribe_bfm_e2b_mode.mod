// ============================================================
//  uribe_bfm_e2b_mode.mod  —  ESTIMACIÓN 2, variante sin cota
//  Chequeo: la cota superior del error de medicion del deficit,
//  puesta en sqrt(0.10*var) = 0.6874, esta atando la estimacion?
//  Acá se saca la cota y se centra la prior en 0.6874 (la lectura
//  alternativa de "a lo mucho 10%").
//
...
//  observable". var(def_obs) = 4.7394 (armar_datos_fiscal.m), asi
//  que el 10% corresponde a un desvio de sqrt(0.10*4.7394) = 0.6874.
...
stderr def_obs, , 0, ,  normal_pdf,  0.6874,  0.3437;
