// ============================================================
//  uribe_bfm_e3_irf.mod  —  Punto 3: IRFs, descomposición de varianza
//  y smoother de la ESTIMACIÓN 3. Carga la moda, no la re-estima.
//
//  Igual que la ESTIMACIÓN 2 (mismos 4 observables, zetaM y zetaF
//  activos), pero además con el shock a la meta z^m2 prendido
//  como en Uribe-B: rho_zm2 = 0.999 calibrado, sigma_zm2 estimado.
//
//  Es la carrera de caballos: zetaF y z^m2 compiten por explicar
//  la misma inflación persistente.
//
//  Maximización de la posterior, mode_compute = 5.
//
//  Uso:  >> dynare uribe_bfm_e3_mode
// ============================================================
...
// z^m2 ACTIVO, calibrado como en Uribe-B
rho_zm2 = 0.999;
...
stderr e_zm2,   , 0, ,  normal_pdf,  0.25,  0.25;   // misma prior que Uribe-B
...
estimation(datafile      = datos_uribe_bfm,
           mode_compute  = 0,
           mode_file     = 'uribe_bfm_e3_mode/Output/uribe_bfm_e3_mode_mode',
           smoother,
           mh_replic     = 0,
           nograph)
