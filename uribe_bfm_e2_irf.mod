// ============================================================
//  uribe_bfm_e2_irf.mod  —  Punto 3: IRFs, descomposición de varianza
//  y smoother de la ESTIMACIÓN 2. Carga la moda, no la re-estima.
//
...
estimation(datafile      = datos_uribe_bfm,
           mode_compute  = 0,
           mode_file     = 'uribe_bfm_e2_mode/Output/uribe_bfm_e2_mode_mode',
           smoother,
           mh_replic     = 0,
           nograph)
...
stoch_simul(order=1, irf=21, nograph, irf_plot_threshold=0,
            ...
            irf_shocks=(e_zm, e_zetaF, e_zetaM))
